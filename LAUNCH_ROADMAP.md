...
- [ ] **Production environment secrets management** - Replace `.env` with Vault/AWS Secrets Manager
- [ ] **Rate limiting per user** - Authenticated users get higher limits than anonymous
- [ ] **Input sanitization** - Add XSS protection for all user-submitted content (reviews, fact-checks)
